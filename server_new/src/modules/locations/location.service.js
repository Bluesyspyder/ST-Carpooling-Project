...
export const autocompleteAddress = async (query) => {
  ...
  // autocompleteWithMapbox now falls back to Nominatim automatically when no token is set
...
export const reverseGeocode = async (lat, lng) => {
  ...
  // reverseGeocodeWithMapbox falls back to Nominatim automatically when no token is set
