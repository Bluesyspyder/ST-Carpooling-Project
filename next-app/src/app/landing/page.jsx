...
const Landing = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-73px)] flex flex-col relative overflow-hidden">
      ...
      {/* ── Hero ── */}
      <main className="flex-grow flex flex-col items-center text-center px-4 sm:px-6 lg:px-8 py-12 sm:py-20 lg:py-32 relative z-10 safe-top safe-bottom">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-7xl md:text-8xl font-extrabold tracking-tight mb-4 sm:mb-6 bg-gradient-to-br from-[var(--text-primary)] via-[var(--text-primary)] to-[var(--text-secondary)] bg-clip-text text-transparent leading-tight"
          >
          ...
          <motion.p
            variants={itemVariants}
            className="text-sm sm:text-lg lg:text-xl text-[var(--text-secondary)] max-w-2xl mb-8 sm:mb-12 leading-relaxed font-medium"
          >
          ...
          {/* CTA Buttons */}
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-14 sm:mb-24 w-full justify-center">
            {user ? (
              user.role === 'hybrid' ? (
                <>
                  <Link
                    href="/create-ride"
                    className="btn-primary px-8 py-4 min-h-[48px] text-base w-full sm:w-auto text-center"
                  >
                    Offer Rides
                  </Link>
                  <Link
                    href="/search"
                    className="glass-panel px-8 py-4 min-h-[48px] flex items-center justify-center text-[var(--text-primary)] font-semibold hover:bg-[var(--bg-surface)] text-base w-full sm:w-auto text-center"
                  >
                    Find Rides
                  </Link>
                </>
          ...
          {/* Stats strip */}
          <motion.div variants={itemVariants} className="flex flex-wrap justify-center gap-6 sm:gap-20 mb-14 sm:mb-24 text-center w-full glass-panel py-6 sm:py-8 px-4 border-none bg-transparent shadow-none">
            {[
          ...
          {/* Feature Cards */}
          <motion.div variants={itemVariants} className="w-full max-w-6xl grid md:grid-cols-3 gap-4 sm:gap-6">

            {/* Feature 1 — Eco */}
            <div className="glass-panel glass-panel-hover p-6 sm:p-8 text-left group">
